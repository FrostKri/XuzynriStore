...
global.owner = ['62895327934887','62895328590064'] // Put your number here
    ...
    let _user = global.DATABASE._data.users[m.sender]
      ...
      let _prefix = plugin.customPrefix ? plugin.customPrefix : conn.prefix ? conn.prefix : global.prefix
        ...
        try {
          ...
          if (m.limit) m.reply(+ m.limit + '𝙇𝙞𝙢𝙞𝙩 𝙎𝙪𝙙𝙖𝙝 𝙏𝙚𝙧𝙥𝙖𝙠𝙖𝙞\n\nJangan lupa order geng!\n\nMau Order? Hubungi #owner')
        }
  			break
  		}
  	}
...
Jangan lupa order Ya Cuy!
Hubungi segera => #creator
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: `╭─֍〔 ⚠️𝐀𝐂𝐂𝐄𝐒𝐒 𝐃𝐄𝐍𝐈𝐄𝐃⚠️ 〕֍─
⬡ Perintah ini hanya untuk developer bot
╰─────────────────֍`,
    owner: `╭─֍〔 ⚠️𝐀𝐂𝐂𝐄𝐒𝐒 𝐃𝐄𝐍𝐈𝐄𝐃⚠️ 〕֍─
⬡ Perintah ini hanya untuk owner bot
╰─────────────────֍`,
    mods: `╭─֍〔 ⚠️𝐀𝐂𝐂𝐄𝐒𝐒 𝐃𝐄𝐍𝐈𝐄𝐃⚠️ 〕֍─
⬡ Perintah ini hanya untuk moderator bot
╰─────────────────֍`,
    premium: `╭─֍〔 ⚠️𝐏𝐑𝐄𝐌𝐈𝐔𝐌 𝐎𝐍𝐋𝐘⚠️ 〕֍─
⬡ Fitur ini hanya tersedia untuk user *Premium*
╰─────────────────֍`,
    group: `╭─֍〔 ⚠️𝐆𝐑𝐎𝐔𝐏 𝐎𝐍𝐋𝐘⚠️ 〕֍─
⬡ Fitur ini hanya dapat digunakan didalam grup!!
╰─────────────────֍`,
    private: `╭─֍〔 ⚠️𝐏𝐑𝐈𝐕𝐀𝐓𝐄 𝐂𝐇𝐀𝐓 𝐎𝐍𝐋𝐘⚠️ 〕֍─
Fitur ini hanya dapat digunakan diprivate chat
╰─────────────────֍`,
    admin: `╭─֍〔 ⚠️𝐀𝐂𝐂𝐄𝐒𝐒 𝐃𝐄𝐍𝐈𝐄𝐃⚠️ 〕֍─
⬡ Fitur ini hanya tersedia untuk admin grup!!
╰─────────────────֍`,
    botAdmin: `╭─֍〔 ⚠️𝐀𝐂𝐂𝐄𝐒𝐒 𝐃𝐄𝐍𝐈𝐄𝐃⚠️ 〕֍─
⬡ Fitur ini tidak dapat bekerja jika bot tidak menjadi admin
╰─────────────────֍`,
    nsfw: 'NSFW tidak aktif',
    }[type]
  if (msg) return conn.send3Button(m.chat, msg, wm, 'Pemilik Bot', '.owner', 'Rules', '.rules', 'Sewa Bot', '.sewabot', m)
 let unreg = {
  unreg: `╭─֍〔 ⚠️𝐔𝐍𝐑𝐄𝐆𝐈𝐒𝐓𝐄𝐑⚠️ 〕֍─
⬡ Allo mypren👋, @${m.sender.split`@`[0]}
⬡ Register dulu dek biar bisa lihat fitur fitur botnya
...
╰────────֍ `
 ...
 if (unreg) return conn.sendButton(m.chat, unreg, wm, 'Register', '#daftar bego.18', m)
  }
